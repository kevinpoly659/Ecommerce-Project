...
urlpatterns = [
    ...
    path('custom_sales', views.custom_sales, name="customsales"),
    path('export<str:dates>',views.export, name="export"),
    path('customexport/<str:frm>/<str:to>', views.custom_export, name='custom_export'),
